...
import NullProduct from '~/uk/components/NullProduct';
import CustomHeader from '~/uk/components/CustomHeader';
import Pagination from '~/uk/components/Pagination';
import FooterPagination from '~/uk/components/FooterPagination';
    ...
    <>
      ...
      <Container pageHeight={pageHeight} isDesktop={isDesktop}>
        {loading || isLoading ? (
          ...
          <LoadingContainer>
            <strong>
              We couldn&apos;t find any product with this name <br /> Try again.
            </strong>
          </LoadingContainer>
        ) : (
          !isError &&
