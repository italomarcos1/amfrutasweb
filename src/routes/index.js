  ...
  return (
    <>
      <Switch>
        ...
        <AccountRoute path="/dashboard" component={UkControlPanel} isPrivate />
        ...
        <AccountRoute path="/orders" component={UkMyOrders} isPrivate />

        <AccountRoute path="/conta" component={MyAccount} isPrivate />
        <AccountRoute path="/account" component={UkMyAccount} isPrivate />

        <AccountRoute path="/endereco" component={MyAddress} isPrivate />
        <AccountRoute path="/address" component={UkMyAddress} isPrivate />

        <AccountRoute path="/favoritos" component={MyFavorites} isPrivate />
        <AccountRoute path="/favorites" component={UkMyFavorites} isPrivate />

        <ProductsRoute path="/produtos" exact component={Products} />
        <ProductsRoute path="/products" exact component={UkProducts} />
