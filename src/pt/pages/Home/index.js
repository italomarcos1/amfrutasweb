...
import Input from '~/pt/components/HomeInput';
import InputMask from '~/pt/components/HomeInputMask';
import SlideShow from '~/pt/components/SlideShow';
import CategoriesCarousel from '~/pt/components/CategoriesCarousel';
import BlogsCarousel from '~/pt/components/BlogsCarousel';
import Toast from '~/pt/components/Toast';

import DeliveryModal from '~/pt/pages/DeliveryModal';
